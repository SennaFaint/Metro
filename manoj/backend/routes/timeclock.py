    ...
    try:
        ...
        if existing_entry:
            return jsonify({
                ...
                "clock_in_time": existing_entry["clock_in"].isoformat()
            }), 400
        ...
        return jsonify({
            ...
            "employee_id": employee_id,
            "employee_name": employee_name,
            "clock_in_time": doc["clock_in"].isoformat(),
    ...
    try:
        ...
        for entry in entries:
            formatted_entry = {
                ...
                "clock_out": entry["clock_out"].isoformat() if entry.get("clock_out") else None,
